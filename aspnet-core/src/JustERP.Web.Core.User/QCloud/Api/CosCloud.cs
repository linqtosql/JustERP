...
using System.Text;
using System.Web;
using JustERP.Web.Core.User.QCloud.Common;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;
using QCloud.CosApi.Common;

namespace JustERP.Web.Core.User.QCloud.Api
{
 	public class CosCloud
	{
		...
		private bool isCustomerHeader(string key)
		{
			if (key.Equals(CosParameters.PARA_CACHE_CONTROL)
			          ...
			          || key.StartsWith((string) CosParameters.PARA_X_COS_META_PREFIX)) {
				return true;
			}
