...
namespace JustERP.Migrations
{
    ...
    [Migration("20180526060423_MyTimeChangeAvatarImgLength")]
    partial class MyTimeChangeAvatarImgLength
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JustERP.Core.User.Activities.MtLabelCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JustERP.Core.User.Pepoles.MtPeople", b =>
                {
                    ...
                    b.HasIndex("PeopleWechatInfoId");

                    b.ToTable("Peoples");
                });

            modelBuilder.Entity("JustERP.Core.User.Pepoles.MtPeopleWechatInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JustERP.Core.User.Pepoles.MtPeople", b =>
                {
                    b.HasOne("JustERP.Core.User.Pepoles.MtPeopleWechatInfo", "PeopleWechatInfo")
                        .WithMany()
                        .HasForeignKey("PeopleWechatInfoId");
                });
