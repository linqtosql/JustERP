...
namespace JustERP.Migrations
{
    ...
    [Migration("20171230101513_AddWechatPayToPayment")]
    partial class AddWechatPayToPayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JustERP.Core.User.Charts.LhzxExpertOrderChart", b =>
                {
                    ...
                    b.Property<long>("ExperReceiverId");
                    ...
                    b.HasIndex("ExperReceiverId");

                    b.HasIndex("ExpertId");

                    b.HasIndex("ExpertOrderId");

                    b.ToTable("ExpertOrderCharts");
                });

            modelBuilder.Entity("JustERP.Core.User.Experts.LhzxExpert", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JustERP.Core.User.Experts.LhzxExpertAnonymousShip", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ExpertAnonymousShips");
                });
            ...
            modelBuilder.Entity("JustERP.Core.User.Experts.LhzxExpertComment", b =>
                {
                    ...
                    b.Property<long>("CommenterExpertId");
            ...
            modelBuilder.Entity("JustERP.Core.User.Orders.LhzxExpertOrder", b =>
                {
                    ...
                    b.Property<string>("QuestionRemark");

                    b.Property<string>("Remark")
                        .HasMaxLength(512);

                    b.Property<long>("ServerExpertId");
            ...
            modelBuilder.Entity("JustERP.Core.User.Payments.LhzxExpertOrderPayment", b =>
                {
                    ...
                    b.Property<short>("PaymentChannel");
            ...
            modelBuilder.Entity("JustERP.Core.User.Wechat.LhzxExpertWechatInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JustERP.Core.User.Charts.LhzxExpertOrderChart", b =>
                {
                    b.HasOne("JustERP.Core.User.Experts.LhzxExpert", "ReceiverExpert")
                        .WithMany("ReceiverExpertCharts")
                        .HasForeignKey("ExperReceiverId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("JustERP.Core.User.Experts.LhzxExpert", "SenderExpert")
                        .WithMany("SenderExpertCharts")
            ...
            modelBuilder.Entity("JustERP.Core.User.Experts.LhzxExpertClass", b =>
                {
                    ...
                    b.HasOne("JustERP.Core.User.Experts.LhzxExpertClass")
                        .WithMany("ChildrenExpertClasses")
                        .HasForeignKey("ParentId");
                });
