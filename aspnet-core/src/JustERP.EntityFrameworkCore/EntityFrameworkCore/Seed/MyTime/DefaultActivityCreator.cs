...
namespace JustERP.EntityFrameworkCore.Seed.MyTime
{
    public class DefaultActivityCreator
    {
        ...
        private static List<MtActivity> InitialActivities = new List<MtActivity>
        {
            ...
            new MtActivity{Language = "en", Turn = 14, IsSystem = true, IsDefault = true, Icon = "HouseholdWork.png", Name = "Household Work"},
            ...
            new MtActivity{Language = "zh-CN",Turn = 14, IsSystem = true, IsDefault = false, Icon = "HouseholdWork.png", Name = "Household Work"},
